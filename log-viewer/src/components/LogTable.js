...
const LogTable = ({ logs, columns, colWidths, onCellClick, onColumnResizeStart }) => {
  return (
    <div className="log-table" style={{ gridTemplateColumns: colWidths.map(width => `${width}px`).join(' ') }}>
